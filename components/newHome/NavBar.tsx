        ...
        <>
                ...
                <ContentContainerDiv>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <div style={{ display: "flex", alignItems: "center" }}>
                            ...
                            <HamburgerDiv style={{ marginLeft: "24px" }}>
                                <FaBars onClick={() => setOpenSidebar(true)} color={brandColors.black} size={24} />
                            </HamburgerDiv>

                            <div style={{ marginLeft: "24px", display: "flex", alignItems: "center" }}>
                                <Link href={urlPaths.home} passHref>
                                    <NavbarA style={{ marginLeft: "24px" }}>Home</NavbarA>
                                </Link>
                                <div>
                                ...
                                <MyLink to="test" offset={-100} smooth={true} duration={1000} style={{ marginLeft: "24px" }}>
                                    Deposit
                                </MyLink>
                                {isHomeScreen ? (
                                    <MyLink to="offer-section" offset={-100} smooth={true} duration={1000} style={{ marginLeft: "24px" }}>
                                        Offers
                                    </MyLink>
                                ) : (
                                    <Link href={urlPaths.home + "#offer-section"} passHref>
                                        <NavbarA style={{ marginLeft: "24px" }}>Offers</NavbarA>
                                    </Link>
                                )}

                                <Link href="http://blog.bonokey.com" passHref>
                                    <NavbarA style={{ marginLeft: "24px" }}>Blog</NavbarA>
                                </Link>
                                <Link href={urlPaths.contact} passHref>
                                    <NavbarA style={{ marginLeft: "24px" }}>Contact Us</NavbarA>
                                </Link>
            ...
            <SideBarAside isOpen={openSidebar}>
                ...
                <div style={{ marginTop: "24px", textAlign: "center" }}>
                    <div>
                        <Link href={urlPaths.home} passHref>
                            <SidebarA style={{ marginLeft: "24px" }} onClick={() => setOpenSidebar(false)}>
                                Home
                            </SidebarA>
                        </Link>
                    </div>
                    <div style={{ marginTop: "48px" }}>
                        <MySidebarLink to="test" offset={-100} smooth={true} duration={1000} onClick={() => setShowSidebarDropdown(!showSidebarDropdown)}>
                            Financing
                            <FaChevronDown size={15} color={brandColors.black + "95"} style={{ marginLeft: "12px" }} />
                        </MySidebarLink>
                        {showSidebarDropdown && (
                            <SidebarDropdownDiv>
                                <div style={{ padding: "24px 0" }}>
                                    <MySidebarLink to="test" offset={-100} smooth={true} duration={1000} style={{ color: brandColors.white }} onClick={() => setOpenSidebar(false)}>
                                        Personal
                                    </MySidebarLink>
                                </div>
                                <div style={{ padding: "24px 0" }}>
                    ...
                    <div style={{ marginTop: "48px" }}>
                        <MySidebarLink to="test" offset={-100} smooth={true} duration={1000} onClick={() => setOpenSidebar(false)}>
                            Deposit
                        </MySidebarLink>
                    </div>
                    <div style={{ marginTop: "48px" }}>
                        {isHomeScreen ? (
                            <MySidebarLink to="offer-section" offset={-100} smooth={true} duration={1000} onClick={() => setOpenSidebar(false)}>
                                Offers
                            </MySidebarLink>
                        ) : (
                            <Link href={urlPaths.home + "#offer-section"} passHref>

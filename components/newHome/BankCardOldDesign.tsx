...
function BankCardOldDesign(props: Props) {
        ...
        <div className={styles.bank}>
            ...
            <div className={styles.info}>
                <div className={styles.logo}>
                    <Image src={props.bank.logo} alt="" width={146} height={60} layout={"responsive"} />
                </div>
                ...
                <button className={`${styles.contact} ${styles.mobileHide}`} onClick={() => setShowContactPrompt(!showContactPrompt)}>
                    Contact <br /> Bank Representative
                </button>

                <button className={`${styles.contact} ${styles.mobileShow}`} onClick={() => setShowContactPrompt(!showContactPrompt)}>
            ...
            <div className={styles.details}>
                ...
                <button style={showDetail ? { marginLeft: 25 } : { marginLeft: 10 }} onClick={() => setShowDetail(!showDetail)}>
                                ...
                                {!phoneNumberConfirmationResult ? (
                                    <div>
                                        <div style={{ display: "flex", justifyContent: "center", gap: "6px" }}>
                                            <p style={{ fontSize: "1rem", fontWeight: "500", color: brandColors.black }}>+966</p>
                                            <PromptInput
                                                id="userMobile"
                                                type="tel"
                                        ...
                                        <PromptButton
                                            ...
                                            onClick={async (e) => {
                                                ...
                                                try {
                                                    ...
                                                    return signInWithPhoneNumber(firebaseAuth, phoneNumber, firebaseCaptcha)
...
export default BankCardOldDesign;

...
import styles from "../styles/BankAr.module.scss";
...
class BankAr extends React.Component<Props, State> {
    constructor(props) {
        super(props);
            ...
            <div className={styles.bank}>
                ...
                <div className={styles.info}>
                    ...
                    <div className={styles.apr}>
                        <h6>
                            <span>ثابتة</span> {this.state.apr.toFixed(2)}% <span className={styles.type}>APR</span>
                        </h6>
                    ...
                    <div className={styles.text}>
                        <h6>
                            {this.formatNumber(this.state.loan.toFixed(0))} <span style={{ fontSize: 13 }}>ر.س</span>
                        </h6>
                        <p>{this.props.useMaxLoan ? "الحد الاعلى للتمويل" : "مبلغ التمويل"}</p>
                    </div>

                    <div className={styles.text}>
                        <h6>
                            {this.formatNumber(this.state.monthly.toFixed(0))} <span style={{ fontSize: 13 }}>ر.س</span>
                        </h6>
                        <p>القسط الشهري</p>
                    </div>
                    ...
                    <div className={styles.text}>
                        <h6>
                            {this.formatNumber(this.state.total.toFixed(0))} <span style={{ fontSize: 13 }}>ر.س</span>
                        </h6>
                    ...
                    <div className={`${styles.text} ${styles.mobileShow}`}>
                        <h6>
                            {this.state.fees.toFixed(0)} <span style={{ fontSize: 13 }}>ر.س</span>
                        </h6>
                        <p>الرسوم الادارية</p>
                    </div>
                    ...
                    <button className={`${styles.contact} ${styles.mobileShow}`} onClick={() => this.setState({ showContactPrompt: !this.state.showContactPrompt })}>
                        التواصل مع ممثل البنك
                    </button>
                </div>

                <div className={styles.details}>
                    {!this.state.showDetails ? (
                        <p className={styles.text}>قد يختلف معدل النسبة السنوي اعتماداً على مبلغ التمويل والراتب وجهة العمل ومدة استحقاق التمويل المختلفة وقد تتأثر بالسجل الائتماني الخاص لكل عميل</p>
                    ) : (
                        <div className={styles.content}>
                            <div className={styles.features}>
                                <h6>مميزات التمويل الشخصي</h6>
                            ...
                            <div className={styles.detail}>
                                ...
                                <h6>تحويل الراتب</h6>
                                <p>{this.state.salaryTransfer ? "نعم يلزم" : "لا يلزم"}</p>
                            </div>
                    ...
                    <button style={this.state.showDetails ? { marginLeft: 25 } : { marginLeft: 10 }} onClick={() => this.setState({ showDetails: !this.state.showDetails })}>
                        {this.state.showDetails ? "اخفاء" : "التفاصيل"}
                        <i className={styles.icon}>
                            {!this.state.showDetails ? (
                        ...
                        <div className={styles.phoneContact} onClick={() => this.setState({ showContactPrompt: !this.state.showContactPrompt })}>
                            <div className={styles.contentDiv} onClick={(e) => e.stopPropagation()}>
                                {!this.state.userMobileVerified ? (
                                    <div>
                                        <p>لتتمكن من التواصل مع ممثل البنك الرجاء تاكيد رقم الجوال</p>
                                        <div style={{ marginTop: "36px" }}>
                                            {!this.state.userConfirmationResult ? (
                                                <div>
                                                    <div className={styles.inputContainer}>
                                                        <label htmlFor="userMobile">رقم الجوال</label>
                                                        <input
                                                            id="userMobile"
                                                            type="tel"
                                                            dir="ltr"
                                                            ...
                                                            try {
                                                                ...
                                                                return signInWithPhoneNumber(firebaseAuth, this.state.userMobile, captcha)
                                                                    ...
                                                                    .catch((error) => {
                                                                        ...
                                                                        toast.dismiss();
                                                                        toast.error("حصل خطأ الرجاء المحاولة من جديد");
                                                                    });
                                                            } catch (error) {
                                                ...
                                                <div style={{ marginTop: "24px" }}>
                                                    <div className={styles.inputContainer}>
                                                        <label htmlFor="userVerificationCode">رمز التحقق</label>
                                                        <input
                                                            ...
                                                            return this.state.userConfirmationResult
                                                                ...
                                                                .then((userCred) => {
                                                                    ...
                                                                    if (userCred.user) {
                                                                        ...
                                                                        toast.success("تم التحقق من الرقم بنجاح");
